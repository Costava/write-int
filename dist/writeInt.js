(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["writeInt"] = factory();
	else
		root["writeInt"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	function writeInt(number, options) {
		...
		if (writeInt.representable(number, options.lang)) {
			...
			if (num.isZero()) {
				...
				return writeInt[options.lang].write(writeInt.split(num), true, options);
			}

			return writeInt[options.lang].write(writeInt.split(num.abs()), false, options);
		}
	...
	writeInt.en = __webpack_require__(3);
	writeInt.es = __webpack_require__(4);
	writeInt.de = __webpack_require__(5);
	writeInt.eo = __webpack_require__(6);
	writeInt.jb = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  * @returns {string}
	  */
		write: function write(digits, positive, options) {
	  ...
	  * @returns {string}
	  */
		writePositive: function writePositive(digits) {
			var result = "";

			for (var i = digits.length - 1; i > 0; i -= 3) {
				var tri = (i + 1) / 3;

				var amount = this.writePositiveUnder1000([digits[i - 2], digits[i - 1], digits[i]]);
	  ...
	  * @returns {string}
	  */
		writePositiveUnder1000: function writePositiveUnder1000(digits) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  */
		writePositive: function writePositive(digits) {
			...
			for (var i = digits.length - 1; i > 0; i -= 6) {
				...
				if (sixlet > 1) {
					var additional = this.writePositiveUnder1000000(digits.slice(i - 5, i + 1));
					...
					result += this.writePositiveUnder1000000(digits.slice(i - 5, i + 1));
				}
			}
	  ...
	  * @returns {string}
	  */
		writePositiveUnder1000000: function writePositiveUnder1000000(digits) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  ...
	  * @returns {string}
	  */
		writePositive: function writePositive(digits, options) {
			var result = "";
			...
			for (var i = digits.length - 1; i > 0; i -= 3) {
				...
				if (tri >= 3) {
					if (triDigits[2] > 0 || triDigits[1] > 0 || triDigits[0] > 0) {
						...
						if (triDigits[2] == 0 || triDigits[1] == 0 || triDigits[0] == 1) {
							if (singular) {
	  ...
	  * @returns {string}
	  */
		writePositiveUnder1000: function writePositiveUnder1000(digits, options) {
			var result = "";
